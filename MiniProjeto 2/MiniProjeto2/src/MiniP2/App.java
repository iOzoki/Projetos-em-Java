...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Em um reino distante, uma floresta encantada guarda segredos antigos e perigos desconhecidos."
        ...
        if(opções == 1){
            ...
            System.out.println("Ao seguir o caminho iluminado, você encontra uma clareira tranquila, mas logo se depara com um rio furioso bloqueando o caminho." 
            ...
            if(opções == 1){
                ...
                System.out.printf("Construir uma ponte: Depois de enfrentar o monstro da floresta %s e construir uma ponte sobre o rio, você finalmente"
                ...
                + "sem uma maneira fácil de voltar.", varMonstro.nome);
            }
            else if(opções == 2){
                System.out.println("Capítulo 3");
                ...
                System.out.println("Procurar uma passagem secreta: Ao desvendar os enigmas e perigos da caverna oculta, você finalmente chega ao seu final." 
            ...
            System.out.println("A trilha sombria revela-se repleta de desafios imprevistos. Você se depara com uma árvore gigante com raízes que bloqueiam seu caminho." 
            ...
            if(opções == 1){
                ...
                System.out.println("Depois de enfrentar os pássaros gigantes e escalar a árvore, você alcança o topo, apenas para descobrir que está diante de um" 
                ...
                System.out.println("Ao explorar a antiga ruína além da árvore, você desvenda segredos valiosos e encontra artefatos antigos. No entanto, ao tentar sair"
