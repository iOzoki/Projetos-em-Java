    ...
    public static void main(String[] args) {
        ...
        if(escolha == 1){
            ...
            if(escolha == 1){
                ...
                varProtagonista.Acao(20);
                capitulo3escolha2escolha2.Mostrar();
            }
        }
